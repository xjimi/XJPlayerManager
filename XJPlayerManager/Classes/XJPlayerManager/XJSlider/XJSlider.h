...
@property(nonatomic, getter=isEnabledVerticalGesture) BOOL enabledVerticalGesture;
@property(nonatomic, getter=isEnabledHorizontalGesture) BOOL enabledHorizontalGesture;
